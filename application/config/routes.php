...
*/
$route['default_controller'] = 'TaskController/index';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['task'] = "TaskController/index";
$route['task/create'] = "TaskController/create";
$route['task/edit/(:any)'] = "TaskController/edit/$1";
